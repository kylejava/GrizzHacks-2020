...
class CorrectGroup extends StatefulWidget {
  @override
  _CorrectGroupState createState() => _CorrectGroupState();
}

class _CorrectGroupState extends State<CorrectGroup> {
            ...
            children: [
              ...
              SizedBox(
                ...
                child:  FlatButton.icon(
                    color: Colors.grey,
                    onPressed: (){
                      if(_controller.text == elementNames[_index]['groupBlock']){
