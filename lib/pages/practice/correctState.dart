...
class CorrectState extends StatefulWidget {
  @override
  _CorrectStateState createState() => _CorrectStateState();
}

class _CorrectStateState extends State<CorrectState> {
            ...
            children: [
              ...
              SizedBox(
                ...
                child:  FlatButton.icon(
                    color: Colors.grey,
                    onPressed: (){
                      if(_controller.text == elementNames[_index]['standardState']){
